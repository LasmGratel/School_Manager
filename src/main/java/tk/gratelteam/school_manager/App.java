...
package tk.gratelteam.school_manager;
...
import tk.gratelteam.school_manager.files.Lines;
import tk.gratelteam.school_manager.files.Read;
import tk.gratelteam.school_manager.files.Write;

import tk.gratelteam.school_manager.language.*;
import tk.gratelteam.school_manager.numbers.SchoolType;
import tk.gratelteam.school_manager.plugins.LoadPlugin;
import tk.gratelteam.school_manager.schools.President;
import tk.gratelteam.school_manager.schools.School;
import tk.gratelteam.school_manager.schools.Student;
import tk.gratelteam.school_manager.schools.Students;
import tk.gratelteam.school_manager.schools.Teacher;
import tk.gratelteam.school_manager.schools.TeacherList;
...
public class App extends javax.swing.JFrame {
    ...
    public App() {
        ...
        president.setAge(r.nextInt(100));
        president.setName("test");
        teacher.setAge(r.nextInt(100));
        ...
        MenuItem itmOpen = new MenuItem("打开");  
            ...
            popMenu.add(itmHide);  
            popMenu.add(itmExit);
            Image image=Toolkit.getDefaultToolkit().getImage("textpurepack/file.png");
            TrayIcon trayIcon = new TrayIcon(image,"School Manager",popMenu);  
            //将托盘图标加到托盘上  
            try {  
                t.add(trayIcon);  
...
//        }
    ...
    public School getSchool(){                        //获取学校
        return school;
    }
    @Deprecated
    public void setError(String text){                 //设置错误
        jLabel8.setText("错误:"+text);
        
    }
    public void error(Throwable e){                    //用Log4j输出错误
        Logger.getLogger().catching(e);
    }
    private void jMenuItem2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem2ActionPerformed
        // TODO add your handling code here:
        
        if((!jTextField1.getText().equals("null")) && (!jTextField2.getText().equals("null"))){              //如果名称和年龄都填写了
            setError("");
            president.setAge(Integer.parseInt(jTextField2.getText()));          //设置年龄
            president.setName(jTextField1.getText());                           //设置名称
        }else{
            setError("名称和年龄必须填写");
    ...
    public String getBirthday(){                                              //获取生日
        return jTextField4.getText();
    }
    @Deprecated
    public boolean vailed(Class type){                                         //如果填写了
    ...
    public void addText(Object...text){                                        //增加日志
        for(Object str:text){
